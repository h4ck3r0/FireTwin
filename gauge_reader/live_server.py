...
# Add current and src directory to path
import sys
...
# Global store for detectors (one per calibration)
            ...
            if message.get('type') == 'frame':
                ...
                try:
                    ...
                    if results['success'] and results['pressure'] is not None:
                        ...
                        # print(f"Updated Pressure: {latest_state['pressure']} {latest_state['unit']}")
